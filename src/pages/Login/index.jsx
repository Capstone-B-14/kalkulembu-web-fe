...
export default function LoginPage() {
  return (
    <div className="bg-[#2E78A6] md:h-full">
      <div className="flex content-center justify-center">
        <div className="relative z-20 left-[330px] mt-[50px]">
          <svg
            width="101"
            height="101"
            viewBox="0 0 101 101"
      ...
      <div className="flex content-center justify-center">
        ...
        <div className="h-[600px] w-[500px] bg-white px-[90px] py-[45px] rounded-[30px] right-[40px] relative z-10 bottom-[50px]">
          ...
          <form>
            ...
            <Button
              className="absolute up-[200px] right-[100px] p-3 mt-20 rounded-xl text-md font-bold w-[150px] bg-[#AFC97E]"
              type="button"
            >
              Masuk
            </Button>
          </form>
          <div className="my-30 mx-3 pb-3">
            <h2>
