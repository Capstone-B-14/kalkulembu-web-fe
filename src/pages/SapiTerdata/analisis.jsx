  ...
  return (
    <div className="flex bg-[#FBFBFB]">
      ...
      <div className="flex flex-col min-w-[370px] mx-16 my-20">
        ...
        <div className="grid">
          <div className="p-4">
            <p className="text-3xl font-bold">Umur Saat Ini</p>
            <p className="font-semibold">
              <span className="text-5xl font-bold">6</span> bulan
            </p>
          </div>
          <div className="grid-flow-col p-4">
            <p className="text-3xl font-bold">Bobot Saat Ini</p>
            <p className="font-semibold">
              <span className="text-5xl font-bold">392</span> kilogram
            </p>
          </div>
          <div className="grid-flow-col p-4">
            <p className="text-3xl font-bold">Kondisi Saat Ini</p>
        ...
        <div className="justify-center mt-20">
          <div className="absolute w-3/5 p-12 bg-gray-100 rounded-lg h-1/2">
            <TimeSeriesChart />
          </div>
        </div>
      </div>
