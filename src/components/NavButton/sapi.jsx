...
export default function NavButtonSapi(){
    ...
    return(
        <div className="flex">
            <div className="flex justify-between gap-8">
                <NavButtonLink text='Analisis' linkto='/sapi-terdata'/>
                <NavButtonLink text='Tabel' linkto='/sapi-terdata/tabel'/>
                <NavButtonLink text='Riwayat' linkto='/sapi-terdata/riwayat'/>
            </div>
        </div>
    );
}