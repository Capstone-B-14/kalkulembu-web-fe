  ...
  return (
    <div className="lg:w-[300px] lg:h-[100px] md:w-[250px] md:h-[75px] items-center justify-center mx-8">
      <div className="flex flex-row justify-center items-center">
        {img && (
          <img src={img} className="w-[50px] md:w-[60px] lg:w-[90px]"></img>
        )}
        <div className="flex flex-col">
          <h1 className="font-semibold text-base lg:text-xl md:text-xl font-roboto">
            {title}
          </h1>
          {children1 && (
            <h2 className="text-base md:text-2xl lg:text-2xl mt-1 font-roboto">
